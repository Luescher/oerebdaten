...
INSERT INTO 
    ...
    SELECT
        ...
        substring(typ_erschliessung_linienobjekt.typ_kt FROM 1 FOR 4) AS artcode,
        'urn:fdc:ilismeta.interlis.ch:2017:NP_Typ_Kanton_Baulinien' AS artcodeliste,      /* TODO: woher stammt die artcodeliste?' */
        CASE 
            WHEN erschliessung_linienobjekt.rechtsstatus IS NULL THEN 'inKraft' /* TODO: tbd */
            ELSE erschliessung_linienobjekt.rechtsstatus
        END AS rechtsstatus,
        erschliessung_linienobjekt.publiziertab,              /* TODO: tbd */
...
(
    ...
    FROM
        ...
        ON typ_dokument.typ_erschliessung_linienobjekt = eigentumsbeschraenkung.t_id,
        basket_dataset
    WHERE
...
INSERT INTO
    ...
    SELECT
        ...
        basket_dataset.basket_t_id AS t_basket,
        basket_dataset.datasetname AS t_datasetname,
        ST_MakeValid(ST_RemoveRepeatedPoints(ST_SnapToGrid(erschliessung_linienobjekt.geometrie, 0.001))) AS linie_lv95,
        erschliessung_linienobjekt.rechtsstatus AS rechtsstatus,
        erschliessung_linienobjekt.publiziertab AS publiziertab,
    ...
    FROM
        ...
        RIGHT JOIN agi_oereb_npl_staging.transferstruktur_eigentumsbeschraenkung AS eigentumsbeschraenkung
        ON erschliessung_linienobjekt.typ_erschliessung_linienobjekt = eigentumsbeschraenkung.t_id,
        (
            SELECT
                basket.t_id AS basket_t_id,
                dataset.datasetname AS datasetname               
    ...
    WHERE
        erschliessung_linienobjekt.t_id IS NOT NULL                                              /* PS stimmt das so?*/
;

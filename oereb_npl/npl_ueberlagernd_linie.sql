...
INSERT INTO 
    ...
    SELECT
        ...
        CASE 
            WHEN ueberlagernd_linie.rechtsstatus IS NULL THEN 'inKraft' /* TODO: tbd */
            ELSE ueberlagernd_linie.rechtsstatus
        END AS rechtsstatus,
        ueberlagernd_linie.publiziertab,              /* TODO: tbd */
...
(
    ...
    FROM
        ...
        ON typ_dokument.typ_ueberlagernd_linie = eigentumsbeschraenkung.t_id,
        basket_dataset
    WHERE
...
INSERT INTO
    ...
    SELECT
        ...
        basket_dataset.basket_t_id AS t_basket,
        basket_dataset.datasetname AS t_datasetname,
        ST_MakeValid(ST_RemoveRepeatedPoints(ST_SnapToGrid(ueberlagernd_linie.geometrie, 0.001))) AS linie_lv95,
        ueberlagernd_linie.rechtsstatus AS rechtsstatus,
        ueberlagernd_linie.publiziertab AS publiziertab,
    ...
    FROM
        ...
        RIGHT JOIN agi_oereb_npl_staging.transferstruktur_eigentumsbeschraenkung AS eigentumsbeschraenkung
        ON ueberlagernd_linie.typ_ueberlagernd_linie = eigentumsbeschraenkung.t_id,
        (
            SELECT
                basket.t_id AS basket_t_id,
                dataset.datasetname AS datasetname               
    ...
    WHERE
        ueberlagernd_linie.t_id IS NOT NULL                                              /* PS stimmt das so?*/
;
